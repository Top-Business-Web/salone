...
@section ('content')
								...
								<div id="general" class="mb-5">
									...
									<div class="card">
										<div class="list-group list-group-flush">
											 <form class="forms-sample" action="{{route('update-admin',[$cityadmin->cityadmin_id])}}" method="post" enctype="multipart/form-data">
                                            {{csrf_field()}}
                                             @if (count($errors) > 0)
                                            @if($errors->any())
                                         ...
                                         @endif
                                            <div class="form-group list-group-item d-flex align-items-center">
                                              ...
                                              <input type="text" class="form-control" name="admin_name" value="{{$cityadmin->cityadmin_name}}" id="exampleInputName1" placeholder="Name">
                                            </div>
                                            <div class="form-group list-group-item d-flex align-items-center">
                                              <label for="exampleInputName1"> Admin Email</label>
                                              <input type="text" class="form-control" name="admin_email" value="{{$cityadmin->cityadmin_email}}" id="exampleInputName1">
                                            </div>
                                            <div class="form-group list-group-item d-flex align-items-center">
                                              <label for="exampleInputName1">Admin phone</label>
                                              <input type="text" class="form-control" name="admin_phone" value="{{$cityadmin->cityadmin_phone}}" id="exampleInputName1">
                                            </div>

                                           <div class="form-group list-group-item d-flex align-items-center">
                                              <label>Admin Image</label>
                                              <input type="hidden" name="old_admin_image" value="{{$cityadmin->cityadmin_image}}">
                                              <img src="{{url($cityadmin->cityadmin_image)}}" style="width:50px; height:50px; border-radius:50%"/>&nbsp; &nbsp;
                                              <div class="input-group col-xs-12">
                                              <div class="form-group">
                                                  <input type="file" name="admin_image" class="form-control" id="customFile" />
                                                </div>
                                            ...
                                            <div class="form-group list-group-item d-flex align-items-center">
                                              ...
                                              <input type="password" class="form-control" name="admin_pass" placeholder="enter_new_password_if_you_want_to_change_the_previous_password" id="exampleInputName1">
                                            </div>
                                            <div class="form-group list-group-item d-flex align-items-center">
                                              <label for="exampleInputName1">Retype_Password</label>
                                              <input type="password" class="form-control" name="password2"  placeholder="Retype_Password" id="exampleInputName1">
                                            </div>
                                            <div class="form-group list-group-item d-flex align-items-center">
                                            <button type="submit" class="btn btn-success width-100">Update</button>
                                           </div>
                                          </form>
										</div>
								...
								<div id="privacyAndSecurity" class="mb-5">
									...
									<div class="card">
										...
										<form action="{{route('update_fcm')}}" method="post">
                                			{{csrf_field()}}
                                			 <div class="form-group list-group-item d-flex align-items-center">
                                              <label for="exampleInputName1">User FCM Server Key<sup>*</sup></label>
                                              <input type="text" class="form-control" id="exampleInputName1" name="user_key"  value="{{$user_api_key}}" required>
                                			</div>
                                			<div class="form-group list-group-item d-flex align-items-center">
                                              <label for="exampleInputName1">Vendor FCM Server Key<sup>*</sup></label>
                                              <input type="text" class="form-control" id="exampleInputName1" name="vendor_key"  value="{{$vendor_app_key}}" required>
                                			</div>
           ...
           <div class="card">
            ...
            <div class="card-body">
              ...
              <h5 class="header-title">Choose One Payment Gateways</h5>
               ...
               <form method="post" class="appsvan-submit params-panel" autocomplete="off" action="{{route('gateway_status')}}" enctype="multipart/form-data">
                {{ csrf_field() }}
                      ...
                      <select class="form-control" name="gateway" required>
                         <option value="razorpay" {{ get_option('razorpay_active') == 'Yes' ? 'selected' : '' }}>Razorpay</option>
                         <option value="stripe" {{ get_option('stripe_active') == 'Yes' ? 'selected' : '' }}>Stripe</option>
                         <option value="paystack" {{ get_option('paystack_active') == 'Yes' ? 'selected' : '' }}>Paystack</option>

                      </select>
                      </div>

                      <div class="form-group">
                      <label class="control-label">Please update the Payment Currency</label>           <p>Mandatory*<sup></sup></p>
              ...
              @if(get_option('stripe_active')=='Yes')
                <br>
                <h5 class="header-title">Stripe</h5>
                <div class="params-panel border border-dark p-3">
                  <div class="row">
                    <div class="col-md-3">
                      <div class="form-group">
                      <label class="control-label">Stripe Active</label>
                      <select class="form-control" disabled>
                         <option value="Yes"  {{ get_option('stripe_active') == 'Yes' ? 'selected' : '' }}>Yes</option>
                         <option value="No"  {{ get_option('stripe_active') == 'No' ? 'selected' : '' }}>No</option>
                      </select>
                      </div>
                    </div>
              ...
              @if(get_option('razorpay_active')=='Yes')
                <br>
                <h5 class="header-title">Razorpay</h5>
                <div class="params-panel border border-dark p-3">
                  <div class="row">
                    <div class="col-md-4">
                      <div class="form-group">
                      <label class="control-label">Razorpay Active</label>
                      <select class="form-control" disabled>
                         <option value="No"  {{ get_option('razorpay_active') == 'Yes' ? 'selected' : '' }}>Yes</option>
                         <option value="Yes"  {{ get_option('razorpay_active') == 'No' ? 'selected' : '' }}>No</option>
                      </select>
                      </div>
                    </div>
              ...
              @if(get_option('paystack_active')=='Yes')
                <br>
                <h5 class="header-title">Paystack</h5>
                <div class="params-panel border border-dark p-3">
                  <div class="row">
                    <div class="col-md-4">
                      <div class="form-group">
                      <label class="control-label">Paystack Active</label>
                      <select class="form-control"  disabled>
                         <option value="No"  {{ get_option('paystack_active') == 'Yes' ? 'selected' : '' }}>Yes</option>
                         <option value="Yes"  {{ get_option('paystack_active') == 'No' ? 'selected' : '' }}>No</option>
                      </select>
                      </div>
                    </div>
                    ...
                    <div class="col-md-4">
                      <div class="form-group">
                      <label class="control-label">Paystack Public Key</label>
                    ...
                    <div class="col-md-4">
                      <div class="form-group">
                      <label class="control-label">Paystack Secret Key</label>
                  ...
                  <!-- BEGIN #map -->
							...
							<div class="col-xl-3">
								...
								<nav id="sidebar-bootstrap" class="navbar navbar-sticky d-none d-xl-block">
									<nav class="nav">
										<a class="nav-link" href="#general" data-toggle="scroll-to">Account Setting</a>
										...
										<a class="nav-link" href="#mediaAndFiles" data-toggle="scroll-to">Map & Location Settings</a>
