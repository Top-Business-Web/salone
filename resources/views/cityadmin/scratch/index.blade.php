...
@section('content')
  ...
  <div class="content-wrapper">
        <div class="card">
            <div class="card-body">
              <a class="btn btn-success" style="float: right;" href="{{route('adminScratchEarnAdd')}}">{{ __('keywords.Add')}}</a>
              <br><br>
                          ...
                          <tr>
                           ...
                           <td>{{$adminScratchEarns->min_cart_value}}</td>
                            <td>
                              ...
                              <a href="{{route('adminScratchEarnEdit', [$adminScratchEarns->id])}}" class="btn btn-primary">{{ __('keywords.Edit')}}</a>
                             
                              <button class="btn btn-danger" data-toggle="modal" data-target="#deleteModal-{{$adminScratchEarns->id}}">{{ __('keywords.Delete')}}</button>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-light" data-dismiss="modal">{{ __('keywords.Cancel')}}</button>
      </div>
    </div>
  </div>
</div>
