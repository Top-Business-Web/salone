		...
		<div class="login">
			...
			<div class="login-content">
			     @if (count($errors) > 0)
                  ...
                  @endif
              @endif
				<form class="user" method="post" action="{{route('checkcityadmin-login')}}">
				     {{csrf_field()}}
					...
					<div class="form-group">
						...
						<input type="text" class="form-control form-control-lg fs-15px" value="" name="cityadmin_email" placeholder="username@address.com" />
					</div>
					<div class="form-group">
						<div class="d-flex">
						...
						<input type="password" class="form-control form-control-lg fs-15px" value="" name="cityadmin_pass" placeholder="Enter your password" />
					</div>
