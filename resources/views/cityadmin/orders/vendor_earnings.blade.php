            ...
            <table class="table">
                  ...
                  <tfooter class="thead-dark">
                    <tr>
                      ...
                      <th scope="col">Rs.{{$share_sent_amount}}</th>
                    </tr>
                  </tfooter>
                </table>
            ...
            <table class="table">
                  ...
                  <tfooter class="thead-dark">
                    <tr>
                      ...
                      <th scope="col"></th>
                      <th scope="col">Total</th>
                      <th scope="col">Rs.{{$share_given_amount}}</th>
                    </tr>
                  </tfooter>
                </table>
                </table>
...
<div class="modal fade" id="exampleModal3" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-dismiss="modal">{{ __('keywords.Close')}}</button>
        <a href="{{route('paid_to_vendor',[Request()->vendor_id])}}" class="btn btn-success" >Mart as Paid to Vendor</a>
      </div>
    </div>
  </div>
</div>
