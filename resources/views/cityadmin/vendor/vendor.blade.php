  ...
  <div class="card shadow mb-4">
    <div class="card-header py-3">
      ...
      @if (count($errors) > 0)
        ...
        <a class="btn btn-success m-auto" style="float: right;" href="{{route('add-vendor')}}">{{ __('keywords.Add')}}</a>
    </div>
    <div class="card-body">
      <div class="container">
	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			...
			<div class="modal-footer">
				...
				<a href="{{route('delete-vendor', $vendors->vendor_id)}}" class="btn btn-primary">{{ __('keywords.Delete')}}</a>
			</div>
		</div>
	</div>
</div>
