    ...
    <div class="modal-content">
      ...
      <div class="modal-footer" style="display:block;">
        ...
        @if($order->status ==0 || $order->status == 1)
            <a onClick="return confirm('Are You Sure? You Want to Accept This Order');" href="{{url('vendors/product_orders_accepted')}}/{{$order->store_order_id}}" style="color:#fff;" class="btn-lg btn-warning" > Order Accept</a>
            <a onClick="return confirm('Are You Sure? You Want to Cancel This Order');" href="{{url('vendors/product_orders_cancelled')}}/{{$order->store_order_id}}" class="btn-lg btn-danger" > Order Cancel</a>
        @endif
      </div>
    </div>
  </div>
