...
<div class="content-wrapper">
          <div class="row">
            ...
            <div class="col-md-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">{{ __('keywords.Upd_Staff')}}</h4>
                   @if (count($errors) > 0)
                      @if($errors->any())
                  ...
                  <form class="forms-sample" action="{{route('Updatestaff',$staff->staff_id)}}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="exampleInputName1" value="{{$staff->staff_name}}" name="staff_name" placeholder="Enter {{ __('keywords.Staff_Name')}}">
                    </div>
 
                     <div class="form-group">
                      <label class="image-hover">{{ __('keywords.Staff_Img')}} <img src="{{url($staff->staff_image)}}"  style="width: 21px;"></label>
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="exampleInputName1" name="staff_description" value="{{$staff->staff_description}}" placeholder="Enter {{ __('keywords.Staff_Desc')}}">
                    </div>
