            ...
            <div class="col-md-12 grid-margin stretch-card">
              <div class="card">
                ...
                <div class="form-group">
                      <label for="exampleInputName1">{{ __('keywords.Price')}}</label>
                      <input type="text" class="form-control" id="exampleInputName1" name="price" placeholder="Enter MRP">
                    </div>
                   
                 <div class="form-group">
                      <label for="exampleInputName1">Varient<sup>*</sup></label>
                      <input type="text" class="form-control" id="exampleInputName1" name="varient" placeholder="Enter Varient" required>
                  ...
                  @foreach($lang as $langs)
                    ...
                    <button type="submit" class="btn btn-success mr-2">{{ __('keywords.Submit')}}</button>
                     ...
                     <a href="{{route('varient',$id)}}" class="btn btn-light">{{ __('keywords.Cancel')}}</a>
                  </form>
                </div>
              </div>
            </div>
