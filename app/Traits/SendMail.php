...
trait SendMail {
    ...
    private $noreply_email = 'noreply@gomarket.in';
      public function payoutMail($vendor_name,$vendor_email,$app_name,$password) {
       
        $data = array('to' => $vendor_email, 'from' => $this->noreply_email, 'to-name'=>$vendor_name, 'from-name' => $app_name);
      ...
      public function codorderplacedMail($cart_id,$prod_name,$price2,$delivery_date,$time_slot,$user_email,$user_name) {
       ...
       $app_name = "GoMarket";
        ...
        $data = array('to' => $user_email, 'from' => $this->noreply_email, 'to-name'=>$user_name, 'from-name' => $app_name);
    ...
    public function deloutMail($cart_id, $prod_name, $price2,$user_email, $user_name,$rem_price) {
     ...
     public function rechargeMail($user_id,$user_name, $user_email, $user_phone,$add_to_wallet) {
       ...
       $currency = DB::table('currency')
        ...
        $data = array('to' => $user_email, 'from' => $this->noreply_email, 'to-name'=>$user_name, 'from-name' => $app_name,'user_phone'=>$user_phone);
     ...
     public function sendrejectmail($cause,$user,$cart_id) {
       ...
       $currency = DB::table('currency')
        ...
        $data = array('to' => $user->user_email, 'from' => $this->noreply_email, 'to-name'=>$user->user_name, 'from-name' => $app_name);
