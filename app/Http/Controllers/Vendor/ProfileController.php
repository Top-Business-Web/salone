...
class ProfileController extends Controller
{
    ...
    public function vendorProfile(Request $request)
    {
     ...
     if(Session::has('vendor'))
     {
    	 ...
    	 $profile= DB::table('vendor')
           ...
           return view('vendor.profile',compact("vendor_email","profile"));
    }
	else
	 {
    ...
    public function Editvendor(Request $request)
    {
         ...
         return view('vendor.editvendor.editvendor',compact("vendor_email","vendor_id","vendor"));
    }
     ...
     if(Session::has('vendor'))
     {
        ...
        $vendor_email=Session::get('vendor');
         $pass= DB::table('vendor')
           ...
           return view('vendor.change_pass',compact("vendor_email","pass"));
    }
	else
	 {
	    return redirect()->route('vendorlogin')->withErrors($this->login_check_message);
   ...
   public function vendorChangePassword(Request $request)
    ...
    return redirect()->back()->withErrors('this function is disabled for demo.'); 
	 ...
	 {
	    return redirect()->route('vendorlogin')->withErrors('logged out successfully');
	 }
     }
}
