  ...
  if($insert){
      ...
      $count = DB::table('wishlist')
        ...
        $items = DB::table('wishlist')
        	...
        	$message = array('status'=>'1', 'message'=>'Added to Favorites', 'data'=>$data);
        	return $message;
        }
        else{
     ...
     if($count>0){       
        $data = array('fav_count'=>$count,'fav_items'=>$items);
        	$message = array('status'=>'1', 'message'=>'Removed from Favorites', 'data'=>$data);
        	return $message;
     }else{
         $message = array('status'=>'0', 'message'=>'Removed from Favorites');
        	return $message;
     }
        }
        else{
      ...
      if($lang != NULL){
         ...
         if(count($wishlist_item)>0){ 
           ...
           $j=0;
        	...
        	$message = array('status'=>'1', 'message'=>'Favorites List', 'data'=>$data);
        	return $message;   
         }
        else{
        	$message = array('status'=>'0', 'message'=>'Nothing in Favorites');
        	return $message;
        }
        }
