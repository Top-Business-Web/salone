   ...
   public function notificationlist(Request $request)
    {  
        ...
        $notifyby = DB::table('user_notification')
         ...
         if(count($notifyby)>0){
            ...
            $message = array('status'=>'0', 'message'=>'Notification list is emtpy');
            return $message;
        }
    }
    ...
    {  
        ...
        $notifyby = DB::table('user_notification')
         ...
         if($notifyby){
            $message = array('status'=>'1', 'message'=>'All Notifications has been Deleted');
            return $message;
            }
        else{
            $message = array('status'=>'0', 'message'=>'Notification list is empty');
            return $message;
        }
    }
}
